...
async function init() {
  ...
  const res12 = await client.lmove(
    "bikes:repairs",
    "bikes:finished",
    "LEFT",
    "LEFT"
  ...
  const res19 = await client.rpush("bikes:repairs", [
    "bike:1",
    "bike:2",
    "bike:3",
  ]);
  ...
  const res20 = await client.lpush("bikes:repairs", [
    "bike:important_bike",
  ...
  const res22 = await client.rpush("bikes:repairs", [
    "bike:1",
    "bike:2",
    "bike:3",
  ]);
  ...
  const res27 = await client.lpush("bikes:repairs", [
    "bike:1",
    "bike:2",
    "bike:3",
    "bike:4",
  ...
  const res27eol = await client.rpush("bikes:repairs", [
    "bike:1",
    "bike:2",
    "bike:3",
    "bike:4",
